...
def replace_path_with_filename(code, data_folder='data'):
    # 捕捉单引号或双引号包围的文件路径，并替换前缀为 'data/'
    pattern = r'(["\'])[^"\']*\/([^\/"\']+\.[^\/"\']+)\1|(["\'])\b([^"\']+\.[^\/"\']+)\b\3'
    ...
    def replacement(match):
        ...
        return f"{quote}{data_folder}/{filename}{quote}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir", type=str, default='../../results/gpt-4o-mini')
