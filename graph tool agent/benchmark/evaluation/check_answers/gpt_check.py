...
# 第一个目录
directory = '/Users/lixin/downthesky/coding/Python/ProGraph/graph tool agent/benchmark/benchmark/evaluation/gpt-4o-mini'
dataframes = {}
...
# 设置文件名
# 第二个存储结果的文件名
file_path = '../code/gpt_check_results_deepseek_code_only_new_0521.txt'
